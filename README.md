...
**Headline** (197 real sessions, aggregated — see SAVINGS.md for the full table):

1. **36,500:1**: cache-read tokens to uncached input tokens (MEASURED).
2. **99.9%**: share of the characters sent to squire that were kept out of context, across 1,161 calls (MEASURED).
3. **~172.8M**: tokens kept out of context, from characters ÷ 4 (ESTIMATED).
