...
**2026-09-15 to 2026-09-15** &mdash; 1 real call logged, 100.0% backend-ok (0.0% `UNKNOWN`).

| Command | Calls | Ok rate | `UNKNOWN` rate | Chars in | Chars out | Chars saved |
|---|---|---|---|---|---|---|
| `diff` | 1 | 100.0% | 0.0% | 18355 | 1197 | 17158 |

**REAL character counts** (not estimated): 18355 chars in, 1197 chars out, **17158 chars kept out of context**.

ESTIMATED tokens saved: ~4290 (chars/4 heuristic, not a measured token count -- see "Measuring savings" above for the fuller method).
