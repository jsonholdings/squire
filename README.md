...
**2026-09-15 to 2026-09-15** &mdash; 3 real calls logged, 100.0% backend-ok (0.0% `UNKNOWN`).
...
**REAL character counts** (not estimated): 4637698 chars in, 5323 chars out, **4632375 chars kept out of context**.

ESTIMATED tokens saved: ~1158094 (chars/4 heuristic, not a measured token count -- see "Measuring savings" above for the fuller method).
