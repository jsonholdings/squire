...
**2026-09-15 to 2026-09-15** &mdash; 5 model-backed calls logged, 100.0% backend-ok (0.0% `UNKNOWN`), plus 18 short `run` passthrough runs (60 lines of output or fewer, shown raw with no model call and no savings counted).
