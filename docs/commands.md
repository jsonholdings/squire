...
index 2.9s for 32 chunks. The eval worker separately measured 43s cold / 8.7s warm on a
143-chunk repo — relayed here, not independently reverified; re-run on your own repo before
