...
|---|---|
| Turns | 76,751 |
| Cache-read input tokens | 24,115,147,295 |
| Cache-creation input tokens | 340,592,093 |
| Input tokens (uncached) | 932,171 |
| Output tokens | 88,455,278 |
...
### MEASURED — squire's own condensation, from its call ledger (1,018 calls)

| Metric | Value |
|---|---|
| Characters sent to the local model | 289,614,452 |
| Characters returned to the agent | 840,741 |
| Characters kept out of context | 288,773,711 |
...
| Metric | Value | Method |
|---|---|---|
| One-time tokens kept out of context | ~72.2M (72,193,428) | `chars_saved / 4`, counted once |
