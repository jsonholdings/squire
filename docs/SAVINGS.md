...
|---|---|
| Turns | 35,105 |
| Cache-read input tokens | 11,063,602,436 |
| Cache-creation input tokens | 131,985,197 |
| Input tokens (uncached) | 304,088 |
| Output tokens | 33,012,712 |
...
| Metric | Value |
|---|---|
| Characters sent to the local model | 292,689,058 |
| Characters returned to the agent | 843,967 |
| Characters kept out of context | 291,845,091 |
...
| Metric | Value | Method |
|---|---|---|
| One-time tokens kept out of context | ~73.0M (72,961,273) | `chars_saved / 4`, counted once |
