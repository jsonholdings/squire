...
### MEASURED — from 198 real Claude Code sessions

| Metric | Value |
|---|---|
| Turns | 35,314 |
| Cache-read input tokens | 11,149,675,902 |
| Cache-creation input tokens | 132,597,522 |
| Input tokens (uncached) | 308,016 |
| Output tokens | 33,344,237 |

Cache-read tokens outnumber uncached input tokens by roughly **36,000:1** in this sample. Nearly every token a turn pays for is a re-read of prior context, not new information — which is exactly the cost this tool targets.

### MEASURED — squire's own condensation, from its call ledger (1,027 calls)

| Metric | Value |
|---|---|
| Characters sent to the local model | 305,533,658 |
| Characters returned to the agent | 854,590 |
| Characters kept out of context | 304,679,068 |
...
| Metric | Value | Method |
|---|---|---|
| One-time tokens kept out of context | ~76.2M (76,169,767) | `chars_saved / 4`, counted once |
