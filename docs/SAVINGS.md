...
|---|---|
| Turns | 76,307 |
| Cache-read input tokens | 23,983,324,301 |
| Cache-creation input tokens | 337,816,856 |
| Input tokens (uncached) | 920,607 |
| Output tokens | 87,486,395 |

Cache-read tokens outnumber uncached input tokens by roughly **26,000:1** in this
...
These are real, counted bytes: 99.7% of what would otherwise have entered context on
these calls did not.
