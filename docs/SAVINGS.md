...
### MEASURED — from 196 real Claude Code sessions

| Metric | Value |
|---|---|
| Turns | 35,181 |
| Cache-read input tokens | 11,094,244,254 |
| Cache-creation input tokens | 132,202,011 |
| Input tokens (uncached) | 305,980 |
| Output tokens | 33,158,367 |
...
### MEASURED — squire's own condensation, from its call ledger (1,023 calls)

| Metric | Value |
|---|---|
| Characters sent to the local model | 301,186,430 |
| Characters returned to the agent | 848,822 |
| Characters kept out of context | 300,337,608 |
...
| Metric | Value | Method |
|---|---|---|
| One-time tokens kept out of context | ~75.1M (75,084,402) | `chars_saved / 4`, counted once |
