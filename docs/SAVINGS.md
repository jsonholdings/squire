...
### MEASURED — from 201 real Claude Code sessions

| Metric | Value |
|---|---|
| Turns | 35,811 |
| Cache-read input tokens | 11,290,212,941 |
| Cache-creation input tokens | 133,942,892 |
| Input tokens (uncached) | 309,094 |
| Output tokens | 33,634,429 |
...
### MEASURED — squire's own condensation, from its call ledger (1,162 calls)

| Metric | Value |
|---|---|
| Characters sent to the local model | 804,568,473 |
| Characters returned to the agent | 994,563 |
| Characters kept out of context | 803,573,910 |
...
| Metric | Value | Method |
|---|---|---|
| One-time tokens kept out of context | ~200.9M (200,893,478) | `chars_saved / 4`, counted once |
